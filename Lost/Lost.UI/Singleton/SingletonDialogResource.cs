...
namespace Lost
{
    ...
    public abstract class SingletonDialogResource<T> : DialogLogic where T : DialogLogic
    {
        ...
        public static void Initialize()
        {
            ...
            {
                Debug.LogErrorFormat("Tried initializing a SingletonDialogResource {0} while application was quitting.", typeof(T).Name);
                return;
            }
