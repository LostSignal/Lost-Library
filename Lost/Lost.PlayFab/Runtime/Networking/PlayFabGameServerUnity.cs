//-----------------------------------------------------------------------
// <copyright file="PlayFabGameServerUnity.cs" company="Lost Signal LLC">
...
namespace Lost.Networking
{
    ...
    public abstract class PlayFabGameServerUnity : GameServer
    {
        /// <summary>
        ...
        public PlayFabGameServerUnity(IServerTransportLayer transportLayer, PlayFabServerSettingsData serverSettings) : base(transportLayer)
        {
