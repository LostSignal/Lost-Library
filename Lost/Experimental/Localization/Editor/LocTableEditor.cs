//-----------------------------------------------------------------------
// <copyright file="LocTableEditor.cs" company="Lost Signal LLC">
...
namespace Lost
{
    ...
    [CustomEditor(typeof(LocTable))]
    public class LocTableEditor : Editor
    {
        [MenuItem("Lost/Localization Table Editor")]
        public static void ShowWindow()
        {
            EditorWindow.GetWindow<LocTableEditorWindow>(false, "Localization");
        }
    ...
    public class LocTableEditorWindow : EditorWindow
    {
        //// private static NewGrid entriesGrid;

        static LocTableEditorWindow()
        {
