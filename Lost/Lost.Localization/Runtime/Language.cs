...
namespace Lost.Localization
{
    ...
    public class Language
    {
        ...
        public Language(string isoLanguageName, string nativeLanguageName, string languageCode, SystemLanguage systemLanguage, string thousandsSeparator, string decimalSeparator)
        {
