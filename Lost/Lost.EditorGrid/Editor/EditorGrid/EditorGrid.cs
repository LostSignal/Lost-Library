...
namespace Lost.EditorGrid
{
    ...
    public class EditorGrid
    {
        ...
        private static GUIStyle ColumnHeaderGuiStyle
        {
            get
            {
                if (columnHeaderGuiStyle == null)
                {
                    ...
                    {
                        columnHeaderGuiStyle.normal.background = ColorUtil.MakeColorTexture(new Color(0.7f, 0.7f, 0.7f));
        ...
        public void BeginRow()
        {
            ...
            RowGuiStyle.normal.background = ColorUtil.MakeColorTexture(this.GetCurrentRowColor());
        ...
        private Color GetCurrentRowColor()
        {
            ...
            {
                return ColorUtil.IsProTheme() ? new Color(0.298f, 0.298f, 0.298f) : new Color(0.867f, 0.867f, 0.867f);
            }
        }
